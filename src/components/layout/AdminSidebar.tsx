...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  const navItems = [
    ...
    { label: 'Site & Navigation', href: '/admin/settings', icon: Sliders },
    { label: 'Hero Content', href: '/admin/hero', icon: Sparkles },
    { label: 'About Page', href: '/admin/about', icon: Info },
    { label: 'Workflows & Process', href: '/admin/process', icon: Workflow },
    { label: 'Coordination Showcase', href: '/admin/feature', icon: ImageIcon },
    { label: 'Services & Verticals', href: '/admin/services', icon: Wrench },
