...
export const ClientsSection: React.FC<ClientsSectionProps> = ({ clients }) => {
  ...
  return (
    <section className="py-16 sm:py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mb-10 sm:mb-12 text-center">
      ...
      <div className="relative w-full overflow-hidden">
        {/* Left fade mask */}
        <div
          className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-[#F7F5EF] to-transparent z-10"
          aria-hidden="true"
        />
        {/* Right fade mask */}
        <div
          className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-[#F7F5EF] to-transparent z-10"
          aria-hidden="true"
        />
